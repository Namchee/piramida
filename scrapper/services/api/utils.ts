 ...
 *
 * @param {Record<string, string>} query - user input object
 * @return {Query} validated and formatted user input
 */
export function validateQuery(query: Record<string, string | string[]>): Query {
 ...
 *
 * @param {Record<string, string>} param ID param
