    ...
    <>
      ...
      >
        ...
        >
          ...
          <blockquote>
            Anda dapat melihat dokumentasi versi lama melalui tautan{' '}
            <a
              target="_blank"
          ...
          <p>
            ...
            yaitu <strong>REST API</strong> dan <strong>GraphQL API</strong>.
          </p>

          <section id="resource" data-scrollspy>
            <h2>Resource</h2>
            <p>
              API <b>Piramida</b> menyediakan data yang bersumber dari Otoritas
              Jasa Keuangan Republik Indonesia dalam bentuk kumpulan{' '}
              <i>resource</i> yang dapat dipanggil sebagai <i>endpoint</i> HTTP.
            </p>
            <p>
              Terdapat tiga buah <i>resource</i> utama yang disediakan
              oleh API <b>Piramida</b>.
            </p>
          </section>

          <section id="apps" data-scrollspy>
            <h4>Apps</h4>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                <p>
                  Nama aplikasi managemen reksa dana yang diizinkan oleh
          ...
          <section id="illegals" data-scrollspy>
            <h4>Illegals</h4>
            <p>
            ...
            <ul>
              <li>
                ...
                <p>
                  Nomor ID produk investasi ilegal sesuai data yang disimpan
              ...
              <li>
                ...
                <p>
                  Nama produk investasi yang telah dinyatakan ilegal oleh
                  Otoritas Jasa Keuangan Republik Indonesia.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  Jenis aktivitas investasi yang ditawarkan oleh produk
                  investasi ilegal.
                </p>
              </li>
              <li>
          ...
          <section id="products" data-scrollspy>
            <h4>Products</h4>
            <p>
          ...
          <section id="rest" data-scrollspy>
            <h2>REST API</h2>
            <h4>Bentuk Data</h4>
            <p>
              Setiap data yang dikembalikan oleh REST API akan dikembalikan
              dalam bentuk <b>JSON</b>. Berikut merupakan contoh data yang
              dikembalikan oleh API <b>Piramida</b>.
            </p>
            <CodeBox lang="json">
              {endent`{
              "data": {},
            ...
            <ul>
              <li>
                ...
                <p>
                  Data dari hasil permintaan yang dikembalikan. Akan
                  bernilai <code>null</code> apabila <code>error</code>
              ...
              <li>
                ...
                <p>
                  ...
                  Akan bernilai <code>null</code> apabila <code>data</code>{' '}
                  tidak bernilai <code>null</code>.
                </p>
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>405</strong>
                <p>
                  Permintaan dikirimkan menggunakan <i>method</i> HTTP yang
                  tidak diizinkan. Seluruh <i>endpoint</i> dalam API{' '}
          ...
          <section id="rest-apps" data-scrollspy>
            <h3><i>Endpoint</i> Apps</h3>
            <p>
            ...
            <p>
              <b>
                Contoh penggunaan <i>endpoint</i>
              </b>
            </p>
            <p>
              <b>Permintaan</b>
          ...
          <section id="rest-illegals" data-scrollspy>
            <h3><i>Endpoint</i> Illegals</h3>
            <p>
            ...
            <p>
              Mengembalikan seluruh produk investasi yang telah dinyatakan
              ilegal beredar di Indonesia oleh Otoritas Jasa Keuangan Republik
              Indonesia sesuai dengan parameter permintaan yang diberikan.
            </p>
            <b>Parameter Permintaan</b>
            <ul>
              <li>
            ...
            <p>
              Mengembalikan sebuah produk investasi yang telah dinyatakan ilegal
              beredar di Indonesia oleh Otoritas Jasa Keuangan Republik
              Indonesia yang memiliki nomor ID yang sama dengan parameter{' '}
              <code>id</code>.
            </p>
            <b>Parameter Permintaan</b>
            <ul>
          ...
          <section id="rest-products" data-scrollspy>
            <h3>
              <i>Endpoint</i> Products
            </h3>
            <p>
              Kumpulan <i>endpoint</i> yang dapat digunakan untuk memperoleh
            ...
            <p>
              Mengembalikan seluruh produk reksa dana legal yang telah diizinkan
              oleh Otoritas Jasa Keuangan Republik Indonesia sesuai dengan
              parameter permintaan yang diberikan.
            </p>
            <b>Parameter Permintaan</b>
            <ul>
              <li>
            ...
            <p>
              Mengembalikan sebuah produk reksa dana legal yang telah diizinkan
              oleh Otoritas Jasa Keuangan Republik Indonesia yang memiliki nomor
              ID yang sama dengan parameter <code>id</code>.
            </p>
            <b>Parameter Permintaan</b>
            <ul>
              <li>
          ...
          <section id="graphql" data-scrollspy>
            <h2>GraphQL API</h2>
            <p>
              Selain <b>REST API</b>, <b>Piramida</b> juga menyediakan sebuah
              API GraphQL yang dapat diakses melalui tautan{' '}
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <p>
              GraphQL merupakan sebuah <i>query language</i> alternatif dari
              REST. Keunggulan dari GraphQL dibandingkan REST API konvensional
              adalah pengguna dapat menentukan properti-properti mana saja yang
              dikembalikan dalam permintaan yang dikirim di mana hal tersebut
              ...
              >
                <i>over-fetching</i> maupun <i>under-fetching</i>
              </a>{' '}
              serta menyediakan API yang lebih fleksibel.
            </p>
            <p>
              Informasi mengenai tata cara penggunaan API GraphQL dapat dilihat
              melalui{' '}
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <h4>Penggunaan API GraphQL Piramida</h4>
            <p>
            ...
            <p>
              ...
              <b>Piramida</b> untuk memperoleh data seluruh aplikasi reksa dana
              yang telah diizinkan oleh Otoritas Jasa Keuangan Republik
              Indonesia.
            </p>
            <pre>
              {endent`
            ...
            <p>Permintaan tersebut akan menghasilkan data seperti berikut.</p>
            <CodeBox lang="json">
              {endent`
              {
                "data": {
            ...
            <p>
              Untuk penggunaan lebih lanjut, Anda dapat mencoba menggunakan API
              GraphQL <b>Piramida</b> melalui sebuah antarmuka GraphQL{' '}
              <i>playground</i> yang dapat diakses melalui tautan{' '}
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://ojk-invest-api.vercel.app/api/graphql"
